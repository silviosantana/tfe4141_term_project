...
HD_PWD='C:/Users/silvi/workspace/tfe4141_term_project/edit_rsa_accelerator/edit_rsa_accelerator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rsa_accelerator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rsa_accelerator.tcl -notrace
