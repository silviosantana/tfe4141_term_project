...
architecture rtl of rsa_core is
    ...
    --signal curr_state_m1 : state_m1:= WAIT_MSG;
    signal curr_state_m1 : state_m1;
    signal next_state_m1: state_m1;
    
    type state_m2 is (WAIT_RD_MSG, WAIT_MSGOUT_READY, END_READOUT);
    --signal curr_state_m2 :state_m2:=WAIT_RD_MSG;
    signal curr_state_m2 :state_m2;
    signal next_state_m2: state_m2;
    ...
    --signal monexp_input_counter: unsigned(1 downto 0):= (others => '0');
    --signal monexp_output_counter: unsigned(1 downto 0):= (others => '0');
